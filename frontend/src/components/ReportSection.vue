...
.group-title { font-size: 15px; font-weight: var(--font-bold); color: var(--color-text); margin: 0 0 10px 0; }

.report-card { padding: 14px 16px; border-radius: var(--radius-card); border: 1px solid; border-left-width: 4px; margin-bottom: 10px; }
.card-green { background: var(--color-primary-50); border-color: var(--color-primary-soft); border-left-color: var(--color-primary); }
.card-orange { background: var(--color-amber-soft); border-color: var(--color-amber-soft); border-left-color: var(--color-amber); }

.card-header { display: flex; align-items: center; gap: 8px; margin-bottom: 6px; }
.card-num { width: 22px; height: 22px; border-radius: 50%; background: var(--color-surface); display: flex; align-items: center; justify-content: center; font-size: 12px; font-weight: var(--font-bold); color: var(--color-text-secondary); flex-shrink: 0; border: 1px solid var(--color-border); }
.card-title { font-size: 14px; font-weight: var(--font-bold); color: var(--color-text); }
...
.risk-high { background: var(--color-red-soft); border-color: var(--color-red-soft); }
.risk-medium { background: var(--color-amber-soft); border-color: var(--color-amber-soft); }
.risk-low { background: var(--color-primary-50); border-color: var(--color-primary-soft); }
.risk-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 6px; }
.risk-title { display: flex; align-items: center; gap: 6px; font-size: 14px; font-weight: var(--font-bold); color: var(--color-text); }

.follow-up-card { display: flex; gap: 12px; padding: 14px 16px; background: var(--color-blue-soft); border-radius: var(--radius-card); border: 1px solid var(--color-blue-soft); margin-bottom: 8px; }
.fu-num { width: 26px; height: 26px; border-radius: 50%; background: var(--color-blue); color: var(--color-surface); display: flex; align-items: center; justify-content: center; font-size: 12px; font-weight: var(--font-bold); flex-shrink: 0; }
.fu-content { flex: 1; }
.fu-question { font-size: 14px; font-weight: var(--font-semibold); color: var(--color-text); margin: 0 0 4px 0; }
.fu-purpose { display: flex; align-items: center; gap: 4px; font-size: 12px; color: var(--color-blue); margin: 0; }
...
.dim-label { font-size: 13px; color: var(--color-text-secondary); width: 100px; flex-shrink: 0; font-weight: var(--font-semibold); }
.dim-score { font-size: 13px; font-weight: var(--font-semibold); white-space: nowrap; }
</style>
